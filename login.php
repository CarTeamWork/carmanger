...
<div class="row">
<div class="btn-group">
<button type="submit" class="btn btn-info" id="data" onclick="location.href='infos.php'"> about us <img src="photos/1.jpg" alt="image" class="img-circle" > </button>

<button type="submit" class="btn btn-info"id="data" onclick="location.href='cars.php'">our   cars <img src="photos/3.jpg" alt="image" class="img-circle" ></button>

<button type="submit" class="btn btn-info" id="data1" onclick="location.href='newclient.php'"> new customer <img src="photos/31.jpg" alt="image" class="img-circle" > </button>
...
@-webkit-keyframes example {
 0%   {  background-image: url("photos/a11.jpg   "  )  ;}
   25%   {  background-image: url("photos/a14.jpg " )  ;}
    50%  {  background-image: url("photos/a12.jpg   " )  ;}
    75%  {  background-image: url("photos/a15.jpg   " )  ;}
    100% {  background-image: url("photos/a13.jpg  " )  ;}  
}

/* Standard syntax */
@keyframes example {
   0%   {  background-image: url("photos/a11.jpg   " )  ;}
   25%  {  background-image: url("photos/a12.jpg  " )  ;}
    50%  {  background-image: url("photos/a14.jpg   " )  ;}
	    75%  {  background-image: url("photos/a15.jpg  " )  ;}
  100% {  background-image: url("photos/a13.jpg  " )  ;}  
}
body {
